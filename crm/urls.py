...
urlpatterns = [
    ...
    url(r'^newsait21.xml$', views.NewSaitFeedview, name='NewSait'),  # for New Sait(21 centry) feed(no Fakes)
    ...
    url(r'^ncian.xml$', views.cianfeedview1, name='cian'),#new cian feed
    ...
    url(r'^stat_obj_adler/$', views.stat_count_crm_obj_adler, name='crm_obj_index_adler'),
