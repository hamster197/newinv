...
def MyIndexCommerceView(request):
    ...
    if request.POST:
        ...
        if tpform.is_valid():
            ...
            contract = []
            if tpform.cleaned_data['contract'] == 'Без договора':
                contract.append('Без договора')
                contract.append('')
            else:
                contract.append(tpform.cleaned_data['contract'])
            if tpform.cleaned_data['contract'] == 'Все':
                contract.append('')
                contract.append('Без договора')
                contract.append('Агентский')
                contract.append('Эксклюзив')
...
def DetailCommerceView(request, idd):
    ...
    if '_search_board' in request.POST:
        ...
        url_string = "https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&price1=" \
            # "6500000&price2=6500000&city=Сочи&phone=89673270021&category_id=2"
        url_string = url_string + str(tpdom.cena_agenstv) + '&price2=' + str(tpdom.cena_agenstv) + '&city=Сочи&phone='
        url_string = url_string + tpdom.author.userprofile1.ya_tel + '&category_id=7'  # flat.author.userprofile1.ya_tel
        url = url_string
        # url = 'https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&phone=89654561231&source=3&price1=10502000&price2=10502000'
        import time
        time.sleep(5.5)  # Pause 5.5 seconds
        response = requests.request("GET", url, headers=headers, data=payload)
        jmain = dict(response.json())
        for i in jmain['data']:
            urls_ya.append(i['url'])
...
def my_flatview_pub(request):
    ...
    if request.POST:
        ...
        if aFlatSearch.is_valid() and '_submit' in request.POST:
            ...
            contract = []
            if aFlatSearch.cleaned_data['contract'] == 'Без договора':
                contract.append('Без договора')
                contract.append('')
            else:
                contract.append(aFlatSearch.cleaned_data['contract'])
            if aFlatSearch.cleaned_data['contract'] == 'Все':
                contract.append('')
                contract.append('Без договора')
                contract.append('Агентский')
                contract.append('Эксклюзив')
            ...
            #if raionc =='Любой':
            if 'Любой' in raionc:
                flatlist = flat_obj.objects.filter(status_obj='Опубликован', contract__in=contract,
                ...
                flatlist = flat_obj.objects.filter(status_obj='Опубликован',raion__in=raionc,
                                               cena_agenstv__gte=int(minc), cena_agenstv__lte=int(maxc),
                                               ploshad__gte=int(minp), ploshad__lte=int(maxp),
                                               type = 'flat', contract__in=contract,).order_by('-date_sozd')
                #print(flatlist.count())
        ...
        if aFlatSearch.is_valid():
            ...
            if  'Любой' in raionc:
                flatlist = flat_obj.objects.filter(author=request.user,#status_obj='Опубликован',
                                               ...
                                               ploshad__gte=int(minp), ploshad__lte=int(maxp),
                                               type = 'flat',
                                               contract__in=contract,).exclude(status_obj='В архиве').order_by('-date_sozd')
            else:
                flatlist = flat_obj.objects.filter(#status_obj='Опубликован',raion=raionc,
                                               cena_agenstv__gte=int(minc), cena_agenstv__lte=int(maxc),
                                               ploshad__gte=int(minp), ploshad__lte=int(maxp),
...
def myflatDetail(request, idd):
    ...
    if '_search_board' in request.POST:
        ...
        url_string = "https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&price1=" \
            # "6500000&price2=6500000&city=Сочи&phone=89673270021&category_id=2"
        url_string = url_string + str(flat.cena_agenstv) + '&price2=' + str(flat.cena_agenstv) + '&city=Сочи&phone='
        url_string = url_string + flat.author.userprofile1.ya_tel + '&category_id=2' #flat.author.userprofile1.ya_tel
        url = str(url_string)
        #print(url_string)
        #url = 'https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&phone=89654561231&source=3&price1=10502000&price2=10502000'
        #print(url_string)
...
def mu_unpob_doma_view(request):
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            contract = []
            if form.cleaned_data['contract'] == 'Без договора':
                contract.append('Без договора')
                contract.append('')
            else:
                contract.append(form.cleaned_data['contract'])
            if form.cleaned_data['contract'] == 'Все':
                contract.append('')
                contract.append('Без договора')
                contract.append('Агентский')
                contract.append('Эксклюзив')
            if 'Любой' in raion_d:
                doms=flat_obj.objects.filter(type='house',#status_obj='Опубликован',
                                       ...
                                       cena_agenstv__gte=int(minc),contract__in=contract,
...
def dom_detail_view(request, idd):
    ...
    if '_search_board' in request.POST:
        ...
        url_string = "https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&price1=" \
            # "6500000&price2=6500000&city=Сочи&phone=89673270021&category_id=2"
        url_string = url_string + str(dom.cena_agenstv) + '&price2=' + str(dom.cena_agenstv) + '&city=Сочи&phone='
        url_string = url_string + dom.author.userprofile1.ya_tel + '&category_id=4'  # flat.author.userprofile1.ya_tel
        url = url_string
        # url = 'https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&phone=89654561231&source=3&price1=10502000&price2=10502000'
        import time
        time.sleep(5.5)  # Pause 5.5 seconds
        ...
        if form.is_valid() and '_submit' in request.POST:
            ...
            if 'Любой' in raion_d:
                uc=flat_obj.objects.filter(status_obj='Опубликован',type='uchastok',# kr_raion='',
                                       h_ploshad_uch__gte=int(minp), contract__in=contract,
...
def uch_detail_view(request, idd):
    ...
    if '_search_board' in request.POST:
        ...
        url_string = "https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&price1=" \
            # "6500000&price2=6500000&city=Сочи&phone=89673270021&category_id=2"
        url_string = url_string + str(uc.cena_agenstv) + '&price2=' + str(uc.cena_agenstv) + '&city=Сочи&phone='
        url_string = url_string + uc.author.userprofile1.ya_tel + '&category_id=5'  # flat.author.userprofile1.ya_tel
        url = url_string
        # url = 'https://ads-api.ru/main/api?user=insochi@century21.ru&token=c4eef57751055fc4fc9e376e9448d06d&phone=89654561231&source=3&price1=10502000&price2=10502000'
        import time
        time.sleep(5.5)  # Pause 5.5 seconds
...
def reeelt_otchet_all_view(request, tpr_tab):
    ...
    if request.user.groups.get().name == 'Администрация':
        ...
        closet_otchet = otchet_nov.objects.filter(Q(sdelka_zakrita='Да') | Q(sdelka_zakrita='Да-Рассрочка'),
                                                  date_zakr__gte=ds,date_zakr__lte=de).order_by('-date_zakr')
...
######################################################################################################################
        ...
        razn_otch = razn_otch +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Другое').count())
...
######################################################################################################################
        ...
        Avito = Avito +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Avito').count())
...
######################################################################################################################
        ...
        AvitoTurbo = AvitoTurbo +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='ДаРассрочка',
                                              ot_kuda_kl='Avito Turbo').count())
...
######################################################################################################################
        ...
        Cian = Cian +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Vestum').count())
...
######################################################################################################################
        ...
        sait = sait +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Рассрочка',
                                              ot_kuda_kl='Юла').count())
        sait = sait +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Юла').count())
...
######################################################################################################################
        ...
        rec = rec +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='По рекомендации').count())
...
######################################################################################################################
        ...
        domclick = domclick +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Рассрочка',
                                              ot_kuda_kl='Домклик(Сбер)').count())
        domclick = domclick +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Домклик(Сбер)').count())
...
######################################################################################################################
        ...
        Yandex = Yandex +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Рассрочка',
                                              ot_kuda_kl='Yandex Недвижимость').count())
        Yandex = Yandex +(otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                              ot_kuda_kl='Yandex Недвижимость').count())
...
######################################################################################################################
        ...
        all_tel = all_tel + (otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Рассрочка',
                                                     ot_kuda_kl='Звонок с общего телефона').count())
        all_tel = all_tel + (otchet_nov.objects.filter(date_sozd__gte=ds, date_sozd__lte=de, sdelka_zakrita='Да-Рассрочка',
                                                     ot_kuda_kl='Звонок с общего телефона').count())
...
######################################################################################################################
        ...
        sum_adler_rasr5 = otchet_nov.objects.filter(Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
         ...
         #############################################################################
        s_adler = 0
        for sum in sum_adler:
            if grp in sum.otd_reelt1:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc1/100)
            if grp in sum.otd_reelt2:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc2/100)
            if grp in sum.otd_reelt3:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc3/100)
            if grp in sum.otd_reelt4:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc4/100)
            if grp in sum.otd_reelt5:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc5/100)
            if grp in sum.otd_reelt6:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc6/100)
            if grp in sum.otd_reelt7:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc7/100)
            if grp in sum.otd_reelt8:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc8/100)
            if grp in sum.otd_reelt9:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc9/100)
            if grp in sum.otd_reelt10:
                s_adler = s_adler + (sum.komisia * 45 / 100) * (sum.rielt_proc10/100)
        for rasr in sum_adler_rasr1:
            if grp in rasr.otd_reelt1:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt10:
                s_adler = s_adler +((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_adler_rasr2:
            if grp in rasr.otd_reelt1:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_adler = s_adler +((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_adler_rasr3:
            if grp in rasr.otd_reelt1:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_adler = s_adler +((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_adler_rasr4:
            if grp in rasr.otd_reelt1:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_adler = s_adler +((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_adler_rasr5:
            if grp in rasr.otd_reelt1:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_adler = s_adler +((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
        ...
        #############################################################################
        s_sochi = 0
        for sum in sum_sochi:
            if grp in sum.otd_reelt1:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc1 / 100)
            if grp in sum.otd_reelt2:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc2 / 100)
            if grp in sum.otd_reelt3:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc3 / 100)
            if grp in sum.otd_reelt4:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc4 / 100)
            if grp in sum.otd_reelt5:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc5 / 100)
            if grp in sum.otd_reelt6:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc6 / 100)
            if grp in sum.otd_reelt7:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc7 / 100)
            if grp in sum.otd_reelt8:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc8 / 100)
            if grp in sum.otd_reelt9:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc9 / 100)
            if grp in sum.otd_reelt10:
                s_sochi = s_sochi + (sum.komisia * 45 / 100) * (sum.rielt_proc10 / 100)
        for rasr in sum_sochi_rasr1:
            if grp in rasr.otd_reelt1:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt10:
                s_sochi = s_sochi + ((rasr.vneseno_komisii * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_sochi_rasr2:
            if grp in rasr.otd_reelt1:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_sochi = s_sochi + ((rasr.vneseno_komisii2 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_sochi_rasr3:
            if grp in rasr.otd_reelt1:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_sochi = s_sochi + ((rasr.vneseno_komisii3 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_sochi_rasr4:
            if grp in rasr.otd_reelt1:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
                s_sochi = s_sochi + ((rasr.vneseno_komisii4 * 45 / 100) * (rasr.rielt_proc10 / 100))
        for rasr in sum_sochi_rasr5:
            if grp in rasr.otd_reelt1:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc1 / 100))
            if grp in rasr.otd_reelt2:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc2 / 100))
            if grp in rasr.otd_reelt3:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc3 / 100))
            if grp in rasr.otd_reelt4:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc4 / 100))
            if grp in rasr.otd_reelt5:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc5 / 100))
            if grp in rasr.otd_reelt6:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc6 / 100))
            if grp in rasr.otd_reelt7:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc7 / 100))
            if grp in rasr.otd_reelt8:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc8 / 100))
            if grp in rasr.otd_reelt9:
                s_sochi = s_sochi + ((rasr.vneseno_komisii5 * 45 / 100) * (rasr.rielt_proc9 / 100))
            if grp in rasr.otd_reelt10:
    ...
    if request.user.userprofile1.nach_otd == 'Да':
        ...
        return render(request,'any/reel_otchet_all.html', {'tn1':n1, 'tn2':n2, 'tn3':n3, 'tOpOtchet':open_otchet,
                                                           'tClOtchet':closet_otchet, 'trazn':razn_otch, 'tavito':Avito,
                                                           'tSRotchet':sriv_otchet, 'tAvitoTurbo':AvitoTurbo,'tgroup':group,
                                                           'tCian':Cian,'tsait':sait,'trec':rec, 'tpform':form,
       ...
       #     s='0'
        ...
        return render(request,'any/reel_otchet_all.html', {'tn1':n1, 'tn2':n2, 'tn3':n3, 'tOpOtchet':open_otchet,
                                                           'tClOtchet':closet_otchet, 'trazn':razn_otch, 'tavito':Avito,
                                                           'tAvitoTurbo':AvitoTurbo, 'tCian':Cian,'tsait':sait,'trec':rec,
                                                           'tyandex':Yandex, 'tdomclick':domclick, 'tpform':form,
                                                           'tSRotchet':sriv_otchet, 'tRasrOtchet': rasr_otchet,
                                                           'topen_otchet_sum':open_otchet_sum,'tcloset_otchet_sum':closet_otchet_sum,
                                                           'tsriv_otchet_sum':sriv_otchet_sum, 'trasr_otchet_sum':rasr_otchet_sum,
                                                           'tde':date,'t_my_ya_obj':my_ya_obj,'tcrm_obj_week_count':crm_obj_week_count,
                                                           'tpr_tab':tpr_tab})
...
def newvigrView(request):
    n1 = 'Новый обьект на выгрузку(ЦИАН)'
    n2 = 'Основные данные'
    n3 = zayavka.objects.filter(status='Свободен').count()
    d11 =timezone.datetime.now().date()-timedelta(days=timezone.datetime.now().weekday())
    crm_obj_week_count = flat_obj.objects.filter(author_id=request.user.id, date_sozd__gte=d11).count()
...
def cianindexUPview(request):
    ...
    return render(request,'any/indexcian.html',{'tsp':sp, 'tn1':n1, 'tn2':n2, 't_my_ya_obj':my_ya_obj,'tcrm_obj_week_count':crm_obj_week_count,})
...
####################################################
### Statistica po kol-vu objects tek nedelya Sochi
####################################################
...
def stat_count_crm_obj(request):
    ...
    AdlOtdel = stat_obj_crm.objects.filter(auth_group__contains='Отдел Адлер (Калина)').order_by(('-crm_calc'))
    AdlOtdel2 = stat_obj_crm.objects.filter(auth_group__contains='Отдел Адлер (Полякова)').order_by(('-crm_calc'))
    ...
    if otdel4_cn == 'None':
        otdel4_cn = 0
    AdlOtdel_cn1 = stat_obj_crm.objects.filter(auth_group='Отдел Адлер (Калина)').aggregate(Sum('crm_calc'))
    AdlOtdel_cn = str(AdlOtdel_cn1.get('crm_calc__sum'))
    if AdlOtdel_cn == 'None':
        otdel4_cn = 0
    AdlOtdel2_cn1 = stat_obj_crm.objects.filter(auth_group='Отдел Адлер (Полякова)').aggregate(Sum('crm_calc'))
    AdlOtdel2_cn = str(AdlOtdel2_cn1.get('crm_calc__sum'))
    if AdlOtdel2_cn == 'None':
        otdel4_cn = 0
...
####################################################
### Statistica po kol-vu objects tek nedelya Adler
###################################################


@login_required
def stat_count_crm_obj_adler(request):
    d1 = timezone.datetime.now().date()
    d11 =timezone.datetime.now().date()-timedelta(days=timezone.datetime.now().weekday())
    crm_obj_week_count = flat_obj.objects.filter(author_id=request.user.id, date_sozd__gte=d11).count()
    n1 = 'Статистика'
    n2 = 'CRM текущая неделя Адлер'
    if request.user.userprofile1.nach_otd =='Да' or request.user.groups.get().name=='Администрация' or request.user.groups.get().name=='Администрация Адлер':
        nach_otd='Yes'
    else:
        nach_otd='No'
    ...
    otdel1 = stat_obj_crm.objects.filter(auth_group='1 Отдел (Адлер)').order_by('-crm_calc')
    otdel2 = stat_obj_crm.objects.filter(auth_group='2 Отдел (Адлер)').order_by('-crm_calc')
    otdel3 = stat_obj_crm.objects.filter(auth_group='3 Отдел (Адлер)').order_by('-crm_calc')
    otdel4 = stat_obj_crm.objects.filter(auth_group='4 Отдел (Адлер)').order_by('-crm_calc')
    ...
    otdel1_cn1 = stat_obj_crm.objects.filter(auth_group='1 Отдел (Адлер)').aggregate(Sum('crm_calc'))
    otdel1_cn = str(otdel1_cn1.get('crm_calc__sum'))
    otdel2_cn1 = stat_obj_crm.objects.filter(auth_group='2 Отдел (Адлер)').aggregate(Sum('crm_calc'))
    otdel2_cn = str(otdel2_cn1.get('crm_calc__sum'))
    otdel3_cn1 = stat_obj_crm.objects.filter(auth_group='3 Отдел (Адлер)').aggregate(Sum('crm_calc'))
    otdel3_cn = str(otdel3_cn1.get('crm_calc__sum'))
    otdel4_cn1 = stat_obj_crm.objects.filter(auth_group='4 Отдел (Адлер)').aggregate(Sum('crm_calc'))
    otdel4_cn = str(otdel4_cn1.get('crm_calc__sum'))
    AdlOtdel_cn1 = stat_obj_crm.objects.filter(auth_group='5 Отдел (Адлер)').aggregate(Sum('crm_calc'))
    AdlOtdel_cn = str(AdlOtdel_cn1.get('crm_calc__sum'))
...
##########################################################
### Statistica po kol-vu objects proshlaya nedelya Sochi
##########################################################
...
###########################################################
### Statistica po kol-vu objects proshlaya nedelya Adler
###########################################################


@login_required
def stat_count_crm_obj_past_adler(request):
    #d1 = timezone.datetime.now().date()
    d1 = timezone.datetime.now().date()-timedelta(days=timezone.datetime.now().weekday())
    d11 = timezone.datetime.now().date()-timedelta(days=7)
    crm_obj_week_count = flat_obj.objects.filter(author_id=request.user.id, date_sozd__gte=d11).count()
    n1 = 'Статистика'
    n2 = 'CRM прошлая неделя Адлер'
    if request.user.userprofile1.nach_otd =='Да' or request.user.groups.get().name=='Администрация' or request.user.groups.get().name=='Администрация Адлер':
        nach_otd='Yes'
    else:
        nach_otd='No'
    ...
    otdel3 = stat_obj_crm.objects.filter(auth_group='3 Отдел (Адлер)').order_by('-crm_calc')
    otdel4 = stat_obj_crm.objects.filter(auth_group='4 Отдел (Адлер)').order_by('-crm_calc')
    AdlOtdel = stat_obj_crm.objects.filter(auth_group__contains='5 Отдел (Адлер)').order_by(('-crm_calc'))
    #AdlOtdel2 = stat_obj_crm.objects.filter(auth_group__contains='2 Отдел (Адлер)').order_by(('-crm_calc'))
...
def new_reyting_po_sdelkam(request, year_pr):
    ...
    if request.POST:
        ...
        if year_pr == '0':
            date_end = timezone.datetime.now()
            date_start = timezone.datetime.now() - timedelta(days=timezone.datetime.now().day - 1)
            # n2 = 'c ' + str(date_start) + ' по ' + str(date_end)
            n2 = 'за текущий месяц'
            prizn = 1
        ## For 1 Kvartal TEKUSHIY Year
        if year_pr == '1':
        ...
        if year_pr == '5':
            ...
            date_end = str(timezone.datetime.now().year) + '-12-' + str(
                calendar.monthrange(timezone.datetime.now().year, 12)[1])
            n2 = 'c ' + date_start + ' по ' + date_end + '(Текущий год)'
            prizn = 12
        ## For LAST YEAR
        if year_pr == '55':
            date_start = str(int(timezone.datetime.now().year)- 1) + '-01-01'
            date_end = str(int(timezone.datetime.now().year)-1) + '-12-' + str(
                calendar.monthrange(timezone.datetime.now().year, 12)[1])
            n2 = 'c ' + date_start + ' по ' + date_end + '(Прошлый год)'
            prizn = 12
    #####################################################
    ##      End of Dates
    #####################################################
            ...
            if (not user.groups.get().name == 'Администрация'):
                if (not user.groups.get().name == 'Юристы'):
                    if not user.groups.get().name == 'Офис-менеджер':
                        ...
                        s = reyting_po_sdelkam(auth_nic=user.username, auth_group=user.groups.get(), auth_ful_name=name,
                                               sdelok_calc=sdelki_count, cian_count=cian_counts,
                        ...
                        sdelki_sum = otchet_nov.objects.filter(
                              Q(reelt1=user.username) | Q(reelt2=user.username) | Q(reelt3=user.username)
                            | Q(reelt4=user.username) | Q(reelt5=user.username) | Q(reelt6=user.username)
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username), sdelka_zakrita='Да',
                            date_zakr__lte=date_end, date_zakr__gte=date_start)
                        ...
                        #################################################
################################################################################################################################
                        rasr_sum1 = otchet_nov.objects.filter(Q(sdelka_zakrita='Рассрочка') | Q(sdelka_zakrita='Да-Рассрочка'),
                              Q(reelt1=user.username) | Q(reelt2=user.username) | Q(reelt3=user.username)
                            | Q(reelt4=user.username) | Q(reelt5=user.username) | Q(reelt6=user.username)
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username),
                            vneseno_komisii_date__lte= date_end, vneseno_komisii_date__gte=date_start)
                        ...
                        for r1 in rasr_sum1:
                            ...
                            sum = 0
################################################################################################################################
                        rasr_sum2 = otchet_nov.objects.filter(Q(sdelka_zakrita='Рассрочка') | Q(sdelka_zakrita='Да-Рассрочка'),
                              Q(reelt1=user.username) | Q(reelt2=user.username) | Q(reelt3=user.username)
                            | Q(reelt4=user.username) | Q(reelt5=user.username) | Q(reelt6=user.username)
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username),
                            vneseno_komisii_date2__lte= date_end, vneseno_komisii_date2__gte=date_start)
...
################################################################################################################################
                        rasr_sum3 = otchet_nov.objects.filter(
                            ...
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username),
                            vneseno_komisii_date3__lte=date_end, vneseno_komisii_date3__gte=date_start)
...
################################################################################################################################
                        rasr_sum4 = otchet_nov.objects.filter(
                            ...
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username),
                            vneseno_komisii_date4__lte=date_end, vneseno_komisii_date4__gte=date_start)
...
################################################################################################################################
                        rasr_sum5 = otchet_nov.objects.filter(
                            ...
                            | Q(reelt7=user.username) | Q(reelt8=user.username) | Q(reelt9=user.username)
                            | Q(reelt10=user.username),
                            vneseno_komisii_date5__lte=date_end, vneseno_komisii_date5__gte=date_start)
...
################################################################################################################################
    ...
    # all For Krsnodar
    ###########################
    Kzero_bal = reyting_po_sdelkam.objects.filter(sdelok_sum=0, auth_group__in=['Отдел Краснодар 1 (Сметанина)',
                                                                                'Отдел Краснодар 2 (Трущева)'])

    Kudl_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__lte=80000 * prizn, sdelok_sum__gt=1,
                                                 auth_group__in=['Отдел Краснодар 1 (Сметанина)',
                                                                                'Отдел Краснодар 2 (Трущева)']).order_by(
        '-sdelok_sum')
    Kgood_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__lte=120000 * prizn, sdelok_sum__gt=80000 * prizn,
                                                  auth_group__in=['Отдел Краснодар 1 (Сметанина)',
                                                                                'Отдел Краснодар 2 (Трущева)']).order_by(
        '-sdelok_sum')
    Kgreat_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__gt=120000 * prizn,
                                                   auth_group__in=['Отдел Краснодар 1 (Сметанина)',
                                                                                'Отдел Краснодар 2 (Трущева)']).order_by(
        '-sdelok_sum')
    ##########################
    ...
    gr = request.user.groups.get().name
    Nzero_bal = reyting_po_sdelkam.objects.filter(sdelok_sum=0, auth_group=gr)
    Nudl_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__lte=80000 * prizn, sdelok_sum__gt=1,
                                                 auth_group=gr).order_by(
        '-sdelok_sum')
    Ngood_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__lte=120000 * prizn, sdelok_sum__gt=80000 * prizn,
                                                  auth_group=gr).order_by(
        '-sdelok_sum')
    Ngreat_bal = reyting_po_sdelkam.objects.filter(sdelok_sum__gt=120000 * prizn, auth_group=gr).order_by('-sdelok_sum')
    ##########################
    ...
    return render(request,'crm/stat/sdelkareyting.html', {'MForm': form, 'tn1':n1, 'tn2':n2, 'tnach':nach_pr,
                'zero':zero_bal, 'udl':udl_bal, 'good':good_bal,'great':great_bal, 't':date_end,
                'Azero': Azero_bal, 'Audl': Audl_bal, 'Agood': Agood_bal, 'Agreat': Agreat_bal,
                 'Kzero_bal':Kzero_bal, 'Kudl_bal':Kudl_bal, 'Kgood_bal':Kgood_bal,'Kgreat_bal':Kgreat_bal,
...
def DashBoardView(request):
    ...
    sum_sochi_rasr1 = otchet_nov.objects.filter(
        Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
        | Q(otd_reelt4__contains=grp) | Q(otd_reelt5__contains=grp) | Q(otd_reelt6__contains=grp) | Q(
            otd_reelt7__contains=grp)
        | Q(otd_reelt8__contains=grp) | Q(otd_reelt9__contains=grp) | Q(otd_reelt10__contains=grp)
    ...
    sum_sochi_rasr2 = otchet_nov.objects.filter(
        Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
        | Q(otd_reelt4__contains=grp) | Q(otd_reelt5__contains=grp) | Q(otd_reelt6__contains=grp) | Q(
            otd_reelt7__contains=grp)
        | Q(otd_reelt8__contains=grp) | Q(otd_reelt9__contains=grp) | Q(otd_reelt10__contains=grp)
    ...
    sum_sochi_rasr3 = otchet_nov.objects.filter(
        Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
        | Q(otd_reelt4__contains=grp) | Q(otd_reelt5__contains=grp) | Q(otd_reelt6__contains=grp) | Q(
            otd_reelt7__contains=grp)
        | Q(otd_reelt8__contains=grp) | Q(otd_reelt9__contains=grp) | Q(otd_reelt10__contains=grp)
    ...
    sum_sochi_rasr4 = otchet_nov.objects.filter(
        Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
        | Q(otd_reelt4__contains=grp) | Q(otd_reelt5__contains=grp) | Q(otd_reelt6__contains=grp) | Q(
            otd_reelt7__contains=grp)
        | Q(otd_reelt8__contains=grp) | Q(otd_reelt9__contains=grp) | Q(otd_reelt10__contains=grp)
    ...
    sum_sochi_rasr5 = otchet_nov.objects.filter(
        Q(otd_reelt1__contains=grp) | Q(otd_reelt2__contains=grp) | Q(otd_reelt3__contains=grp)
        | Q(otd_reelt4__contains=grp) | Q(otd_reelt5__contains=grp) | Q(otd_reelt6__contains=grp) | Q(
            otd_reelt7__contains=grp)
        | Q(otd_reelt8__contains=grp) | Q(otd_reelt9__contains=grp) | Q(otd_reelt10__contains=grp)
    ...
    if sum_sochi.get('komisia__sum'):
        s_sochi = str(sum_sochi.get('komisia__sum') * 60 / 100)
    else:
        s_sochi = '0'
    if sum_sochi_rasr1.get('vneseno_komisii__sum'):
        s_sochi = str(float(s_sochi) + float(sum_sochi_rasr1.get('vneseno_komisii__sum') * 60 / 100))
    else:
        s_sochi = s_sochi

    if sum_sochi_rasr2.get('vneseno_komisii2__sum'):
        s_sochi = str(float(s_sochi) + float(sum_sochi_rasr2.get('vneseno_komisii2__sum') * 60 / 100))
    else:
        s_sochi = s_sochi

    if sum_sochi_rasr3.get('vneseno_komisii3__sum'):
        s_sochi = str(float(s_sochi) + float(sum_sochi_rasr3.get('vneseno_komisii3__sum') * 60 / 100))
    else:
        s_sochi = s_sochi

    if sum_sochi_rasr4.get('vneseno_komisii4__sum'):
        s_sochi = str(float(s_sochi) + float(sum_sochi_rasr4.get('vneseno_komisii4__sum') * 60 / 100))
    else:
        s_sochi = s_sochi

    if sum_sochi_rasr5.get('vneseno_komisii5__sum'):
        s_sochi = str(float(s_sochi) + float(sum_sochi_rasr1.get('vneseno_komisii5__sum') * 60 / 100))
    else:
        s_sochi = s_sochi
    ...
    if sum_adler.get('komisia__sum'):
        s_adler = str(sum_adler.get('komisia__sum') * 60 / 100)
    else:
        s_adler = '0'

    if sum_adler_rasr1.get('vneseno_komisii__sum'):
        s_adler = str(float(s_adler) + float(sum_adler_rasr1.get('vneseno_komisii__sum') * 60 / 100))
    else:
        s_adler = s_adler

    if sum_adler_rasr2.get('vneseno_komisii2__sum'):
        s_adler = str(float(s_adler) + float(sum_adler_rasr2.get('vneseno_komisii2__sum') * 60 / 100))
    else:
        s_adler = s_adler

    if sum_adler_rasr3.get('vneseno_komisii3__sum'):
        s_adler = str(float(s_adler) + float(sum_adler_rasr3.get('vneseno_komisii3__sum') * 60 / 100))
    else:
        s_adler = s_adler

    if sum_adler_rasr4.get('vneseno_komisii4__sum'):
        s_adler = str(float(s_adler) + float(sum_adler_rasr4.get('vneseno_komisii4__sum') * 60 / 100))
    else:
        s_adler = s_adler

    if sum_adler_rasr5.get('vneseno_komisii5__sum'):
        s_adler = str(float(s_adler) + float(sum_adler_rasr1.get('vneseno_komisii5__sum') * 60 / 100))
    else:
        s_adler = s_adler
    ########################
    ## End for All pribil
    ...
    sOtd = reyting_po_sdelkam.objects.all().exclude(auth_group__contains='Адлер').order_by('-sdelok_sum')[:5]
    aOtd = reyting_po_sdelkam.objects.filter(auth_group__contains='Адлер').order_by('-sdelok_sum')[:5]
    ########################
    ## End for Reiting
    ########################
    ########################
    ...
    sum = otchet_nov.objects.filter(date_zakr__gte=ds1, date_zakr__lte=de1, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m1 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m1 = '0'
    sum = otchet_nov.objects.filter(date_zakr__gte=ds2, date_zakr__lte=de2, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m2 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m2 = '0'
    sum = otchet_nov.objects.filter(date_zakr__gte=ds3, date_zakr__lte=de3, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m3 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m3 = '0'
    sum = otchet_nov.objects.filter(date_zakr__gte=ds4, date_zakr__lte=de4, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m4 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m4 = '0'
    sum = otchet_nov.objects.filter(date_zakr__gte=ds5, date_zakr__lte=de5, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m5 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m5 = '0'
    sum = otchet_nov.objects.filter(date_zakr__gte=ds6, date_zakr__lte=de6, sdelka_zakrita__contains='Да').aggregate(Sum("komisia"))
    if sum.get('komisia__sum'):
        s_sochi_m6 = str(sum.get('komisia__sum') * 60 / 100)
    else:
        s_sochi_m6 = '0'
    ########################
