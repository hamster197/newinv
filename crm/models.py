...
class UserProfile1(models.Model):
    ...
    raion_choises = (('Любой', 'Любой'),('Ареда','Ареда'),('Ахун', 'Ахун'),
        ...
        ('(А) Блиново', '(А) Блиново'), (' (А) Верхнее Веселое', ' (А) Верхнее Веселое'), ('(А) Верхнеимеретинская Бухта', '(А) Верхнеимеретинская Бухта'),
        ('(А) Нижнеимеретинская Бухта', '(А) Нижнеимеретинская Бухта'),('(А) Гол. дали', '(А) Гол. дали'),
    ...
    search_raion = MultiSelectField(max_length=45, default='Любой', verbose_name='Район', choices=raion_choises)#models.CharField
    kr_raion_choise = (('Любой', 'Любой'),('Центральный район (ЦМР)','Центральный район (ЦМР)'),('Фестивальный микрорайон (ФМР)', 'Фестивальный микрорайон (ФМР)'),#('Выбор района', 'Выбор района'),
            ('Юбилейный микрорайон (ЮМР)', 'Юбилейный микрорайон (ЮМР)'), ('Пашковский микрорайон (ПМР)', 'Пашковский микрорайон (ПМР)'),
                       ...
                       ('Район Микрохирургии глаза (МХГ)','Район Микрохирургии глаза (МХГ)'),('Комсомольский микрорайон (КМР)', 'Комсомольский микрорайон (КМР)'),
                       ('Район Энка (п. Жукова)', 'Район Энка (п. Жукова)'), ('Район Гидрострой (ГМР)', 'Район Гидрострой (ГМР)'),
                       ('Микрорайон Репино', 'Микрорайон Репино'), ('Восточно-Кругликовский микрорайон', 'Восточно-Кругликовский микрорайон'),
                       ('Микрорайон 40 лет Победы', 'Микрорайон 40 лет Победы'),
                       ('Район Авиагородок', 'Район Авиагородок'),
                       ('Район Знаменский (пос. Знаменский)', 'Район Знаменский (пос. Знаменский)'),
                       ('Район Новознаменский (пос. Новознаменский)', 'Район Новознаменский (пос. Новознаменский)'),
                       ('Район Аэропорта', 'Район Аэропорта'), ('Микрорайон Музыкальный', 'Микрорайон Музыкальный'),
                       ('Микрорайон Вавилова', 'Микрорайон Вавилова'),
                       ('Микрорайон Учхоз Кубань', 'Микрорайон Учхоз Кубань'),
                       ('Микрорайон Рубероидный', 'Микрорайон Рубероидный'), ('Район Сельхозинститута (СХИ)', 'Район Сельхозинститута (СХИ)'),
                       ('Микрорайон ТЭЦ', 'Микрорайон ТЭЦ'), ('Западный обход', 'Западный обход'),
                       ('Московский район (ул. Московская)', 'Московский район (ул. Московская)'),
                       ('Район Горхутор', 'Район Горхутор'),
                       ('Микрорайон Молодежный', 'Микрорайон Молодежный'), ('Район Завода Измерительных приборов (ЗИП)', 'Район Завода Измерительных приборов (ЗИП)'),
                       ('Район Краевой больницы (ККБ)', 'Район Краевой больницы (ККБ)'), ('Район ул. Российской', 'Район ул. Российской'),
                       ('Район Витаминкомбината', 'Район Витаминкомбината'),
                       ('Район Ростовское шоссе', 'Район Ростовское шоссе'),
                       ('Район Баскет Холл', 'Район Баскет Холл'), ('Район 2-я площадка', 'Район 2-я площадка'),
                       ('Немецкая Деревня', 'Немецкая Деревня   '), ('Поселок Северный', 'Поселок Северный'),
                       ('Район Горгаз', 'Район Горгаз'),
                       ('Микрорайон Панорама', 'Микрорайон Панорама'),
                       ('Школьный микрорайон (ШМР)', 'Школьный микрорайон (ШМР)'), ('Район Красная площадь', 'Район Красная площадь'),
                       ('Район Ипподрома', 'Район Ипподрома'), ('Район Аврора', 'Район Аврора'),
                       ('Район КСК в Краснодаре', 'Район КСК в Краснодаре'),
                       ('Район 9 Тихая', 'Район 9 Тихая'),
                       ('Район ул. Кожевенная', 'Район ул. Кожевенная'), ('Район Табачка', 'Район Табачка'),
                       ('Район Хлопчатобумажный комбинат (ХБК)', 'Район Хлопчатобумажный комбинат (ХБК)'),
                       ('Район ремонтно-механического завода (РМЗ)', 'Район ремонтно-механического завода (РМЗ)'),
                       ('Район 9 километр', 'Район 9 километр'),
                       ('Поселок Южный', 'Поселок Южный'),
                       ('Хутор Ленина', 'Хутор Ленина'), ('Поселок Краснодарский', 'Поселок Краснодарский'),
                       ('Станица Елизаветинская', 'Станица Елизаветинская'), ('Станица Северская', 'Станица Северская'),
                       ('Поселок Яблоновский', 'Поселок Яблоновский'),
                       ('Поселок Березовый', 'Поселок Березовый'),
...
class flat_obj(models.Model):
    ...
    raion=models.CharField('Район', choices=raion_choise, max_length=40 , default='', blank=True)
    kr_raion_choise = (('Центральный район (ЦМР)','Центральный район (ЦМР)'),('Фестивальный микрорайон (ФМР)', 'Фестивальный микрорайон (ФМР)'),#('Выбор района', 'Выбор района'),
            ('Юбилейный микрорайон (ЮМР)', 'Юбилейный микрорайон (ЮМР)'), ('Пашковский микрорайон (ПМР)', 'Пашковский микрорайон (ПМР)'),
                       ('Славянский микрорайон (СМР)','Славянский микрорайон (СМР)'),('Микрорайон Черемушки (ЧМР)', 'Микрорайон Черемушки (ЧМР)'),
                       ('Район Микрохирургии глаза (МХГ)','Район Микрохирургии глаза (МХГ)'),('Комсомольский микрорайон (КМР)', 'Комсомольский микрорайон (КМР)'),
                       ('Район Энка (п. Жукова)', 'Район Энка (п. Жукова)'), ('Район Гидрострой (ГМР)', 'Район Гидрострой (ГМР)'),
    ...
    dom_numb = models.CharField(max_length=37, verbose_name='Номер дома:',
                                help_text='например: 36 или 11/2 или 16к (Буква обязательно маленкая!)', default='')
    ...
    krdedit_choises=(('Ипотека СберБанк', 'Ипотека СберБанк'), ('Ипотека РоссельхозБанк', 'Ипотека РоссельхозБанк'),
                     ('Ипотека ВТБ24', 'Ипотека ВТБ24'), ('Мат.капитал', 'Мат капитал'), ('Воен ипотека', 'Воен ипотека'),
    ...
    #       For Commerce
    ##################################################################################################
    type_building_choises = (('Торговое помещение','Торговое помещение'),
    ...
    #       End of For Commerc
    ##################################################################################################
    main_pct = models.ImageField(verbose_name='Главное фото', upload_to='image/%Y/%m/%d/real/main', blank=True,)
    def __str__(self):
        return self.komnat
    class Meta:
